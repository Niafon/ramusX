...
public class QualifierTable extends JXTreeTable {
    ...
    private ImageIcon leafIcon = IconLoader.getIcon(getClass(), "/com/ramussoft/gui/table/qualifier.png");

    private ImageIcon folderIcon = IconLoader.getIcon(getClass(), "/com/ramussoft/gui/table/folder.png");

    private ImageIcon folderSheetIcon = IconLoader.getIcon(getClass(), "/com/ramussoft/gui/table/folder-sheet.png");
